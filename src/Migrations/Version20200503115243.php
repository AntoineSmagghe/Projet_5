 ...
 */
final class Version20200503115243 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE article CHANGE modified_by_id modified_by_id INT DEFAULT NULL, CHANGE date_event date_event DATETIME DEFAULT NULL, CHANGE updated_at updated_at DATETIME DEFAULT NULL, CHANGE api_data api_data LONGTEXT DEFAULT NULL COMMENT \'(DC2Type:array)\', CHANGE youtube youtube LONGTEXT DEFAULT NULL COMMENT \'(DC2Type:array)\'');
