 ...
 */
final class Version20200509204321 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE article ADD facebook LONGTEXT DEFAULT NULL COMMENT \'(DC2Type:array)\', CHANGE modified_by_id modified_by_id INT DEFAULT NULL, CHANGE date_event date_event DATETIME DEFAULT NULL, CHANGE api_data api_data LONGTEXT DEFAULT NULL COMMENT \'(DC2Type:array)\', CHANGE updated_at updated_at DATETIME DEFAULT NULL, CHANGE youtube youtube LONGTEXT DEFAULT NULL COMMENT \'(DC2Type:array)\'');
